...
#### Play Store Link
https://play.google.com/store/apps/details?id=com.nirbhay.flappymusketeer
...
* Dynamic Color Schemes → Experience the game in various color schemes, each representing a different theme.
* Game Themes → Choose from a variety of themes, such as Twitter, SpaceX, and more, each with its unique visual style.
...
* User Input → Players interact by tapping or clicking the screen to control the jetpack character's upward movement.
* Physics → The game simulates gravity, creating an upward movement when the player taps.
* Collision Handling → Collisions between the jetpack character and obstacles result in game over and score display.
...
Create pull requests for new ideas/thoughts or bugs/open issues.
...
* Mateusz Bieś → <a href="https://dribbble.com/shots/22145813-Twitter-Logo-Rebranding">App Logo</a>
